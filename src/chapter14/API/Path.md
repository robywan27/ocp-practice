...
| resolve(String p)                                   | concatenate paths<br/>- if an absolute path is provided as parameter, that is the value returned                                                                                                                                                                                                |
| resolve(Path p)                                     | concatenate paths<br/>- if an absolute path is provided as parameter, that is the value returned                                                                                                                                                                                                |
...
> depth value of 0 indicates the current path itself; to get any result if current path is a directory, maxDepth must be at least 1
