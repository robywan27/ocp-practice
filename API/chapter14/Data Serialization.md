...
- only instance fields are serialized, i.e. value is read from file and re-assigned
- static fields keep their values for the duration of the program

### Serialize a class
- implement Serializable interface -> otherwise NotSerializableException is thrown
- every instance member of the class must be serializable (all primitive type and String are serializable), transient or have null value
...
- static and transient fields are not deserialized; they are initialized to their default values
