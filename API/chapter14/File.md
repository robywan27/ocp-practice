...
| Create directory; throws exception if dir exists                   |                       | file.mkdir()                          |                              | Files.createDirectory(Path dir,     <span style="color: green">FileAttribute... o</span>) <span style="color: red">throws IOException</span> |
