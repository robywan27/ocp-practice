...
|                     | instantiate (multiple levels of nesting)                                                         | OutermostEnclosingClassName.EnclosingClassName.InnerClassName innerObject = enclosingObject.new InnerClassName(); |
...
| MUST            |                                                 | CANNOT          |                                                | CAN                 |                                                                                                            |
|-----------------|-------------------------------------------------|-----------------|------------------------------------------------|---------------------|------------------------------------------------------------------------------------------------------------|
| anonymous class | either extend a class or implement an interface |                 |                                                |                     |                                                                                                            |
